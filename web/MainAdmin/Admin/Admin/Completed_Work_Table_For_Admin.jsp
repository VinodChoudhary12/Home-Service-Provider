...
<div class="container mt-5" >
    <center><h2 style="margin: 20px 0px; color: #FFC107;">Completed Work </h2></center>
    <div class="table-responsive">
        

<table class="table w-90 table table-hover table-bordered border" align="center" >
  <thead>
    <tr>
      ...
      <th scope="col">Done By Vendor</th>
