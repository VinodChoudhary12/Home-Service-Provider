      ...
      We offer upto 7 days warranty on the service in case of recurring issues of the same nature where repair was done </p>
          ...
          <div class="accordion-item border border-white">
            ...
            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
              <div class="accordion-body">
               <p style="margin-top: 15px;">After you book the service, plumbers in your area will receive a notification coordinated by Joboy customer service. Kindly wait for the confirmation message.
                ...
                When the work is over, our agent will let you know the service charge. Please make the payment accordingly online on our platform or by cash to the service provider</p>
              </div>
            </div>
          </div>
          <br>
