         ...
         <button type="button" class="btn btn-warning me-5" style="border-radius: 13px; font-weight: bold;">
            <li  id= "li1" class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="profileproject.jsp">MY PROFILE</a></li>
...
<!--          <li class="nav-item">
  ...
  <marquee style="height:25px; background-color: rgb(212,237,218); color: rgb(91,97,105);" behavior="alt" direction="left"><pre style="background-color: rgb(212,237,218); color: rgb(91,97,105);"   >Well-Come to Home Service Provider                        Well-Come to Home Service Provider                        Well-Come to Home Service Provider</pre></marquee>
    ...
    <div  class="container">
     ...
     <p style="margin-top: 15px;">• The Service Partners may visit your location or will call you to get detailed requirements, we offer all types of pest control services. 
      ...
      • For the best results and longevity post-service, follow the advice given by the pest control team.</p>
          ...
          <div class="accordion-item border border-white">
            ...
            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
              <div class="accordion-body">
               <p style="margin-top: 15px;">• Ensure service booking 24 hours before your convenient time.

               • Home Service  expert will arrive at your place and choose an apt product according to the type and degree of infestation. You will get the most effective and safe pest control in the city</p>
              </div>
            </div>
          </div>
          <br>
  ...
  <strong>Protect your homes from bugs and pests with Home service's expert Pest Control team, now in Indore city!</strong>
  
  <p style="margin-top: 20px;">From replacing a fuse to changing the wiring, we have it all. Connect with Home service for expert electrical services in INDORE.
  
  Are electrical problems disrupting your routine? The circuit breaker could trip, or some tube lights may flicker. The insulation on wires may have worn off, or there could be rusting of the electric panels. Outdated wiring and faulty circuits are hazardous. However, finding an electrician at peak hours in indore is difficult. Not anymore,Home Service has it covered.
  
   connects you to safe electrical servicing even at odd times.
  
  Experienced electricians around your area have partnered with Joboy to deliver timely electrical services at affordable rates. Prioritizing your safety, we offer services at late hours in and around Indore. The electricians in Electronic City and Sarjapur are taken after background verification by a third party. Home service gives seven days warranty for the electrical repairs in Indiranagar and other areas. The service providers are also available in the key areas of Whitefield and M G Road. The service team partnered with Home Service provides on-demand service as per your convenience in Koramangala. Connect with us in Bangalore and get efficient services at the best rates.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container mt-3">
        ...
        <div class="row row-cols-lg-4 row-cols-md-2 row-cols-sm-1">
            ...
            <div class="col "><img  class="img-fluid w-50 h-50 mt-4" id="img2 " src="plumber1.jpg"alt=""><h3>PLUMBER</h3></div>
            <div class="col"><img  class="img-fluid w-75 h-50" id="img2" src="Water-Purifier.png"  alt=""><h3>WATER-PURIFIER</h3></div>
            <div class="col"><img  class="img-fluid w-50 h-50" id="img2" src="https://joboyindia.s3.amazonaws.com/jobservice/ac-service-in-bangalore.png" alt=""><h3>AC REPAIR</h3></div>
