        ...
        <div class="row row-cols-lg-1 row-cols-1 shadow-lg">
            <div class="col">
                <h3 style="font-weight: bold; margin-top: 20px; margin-left: 15px;">PLUMBER</h3>
                 ...
                 <!--<button name='Plumber' class="btn btn-warning ms-5" style="border-radius: 10px; font-weight: bold; float: right; margin-top: -40px; margin-right: 13px;"><a style="text-decoration: none; color: black;" href="../User/LoginUser.jsp">BOOK NOW</a></button>-->
                 <form action="../User/LoginUser.jsp" >
                 <button type="submit" name="name" value='Plumber' class="btn btn-warning ms-5" style="border-radius: 10px; font-weight: bold; float: right; margin-top: -40px; margin-right: 13px;">BOOK NOW</button>
                 </form>
                <span>-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------</span>
