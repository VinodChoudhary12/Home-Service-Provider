...
<body> 
    ...
    <body>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
              <li class="nav-item dropdown">
                <button type="button" class="btn btn-warning ms-3" style="border-radius: 10px; font-weight: bold;">LOGIN</button>
              ...
              <li class="nav-item">
                <a class="nav-link active" id="navbar2" aria-current="page" href="#">SERVICES</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" id="navbar2" aria-current="page" href="#">SHOPINGS</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" id="navbar2" aria-current="page" href="#">DEALS</a>
              </li>
              <li class="nav-item">
      ...
      <marquee style="background-color: rgb(212,237,218); color: rgb(91,97,105);"behavior="alt" direction="left">Get Rs. 75 OFF on Electrician and Plumbing Services. Limited Time Offer! Use code REPAIR75  !!!   Get Rs. 75 OFF on Electrician and Plumbing Services. Limited Time Offer! Use code REPAIR75   !!!   Get Rs. 75 OFF on Electrician and Plumbing Services. Limited Time Offer! Use code REPAIR75 !!</marquee>
         <h1 style="margin-left: 50px;"><b>MY ORDER </b></h1> <br><br>
        <h4   style="margin-left: 50px;"><b> FILTER BY</b></h4><br> 
        <pre class="h6"> <b>           ORDER TYPE          ORDER TYPE            ORDER TYPE              ORDER TYPE        <button type="button" class="btn btn-dark"style=" width: 100px; margin-top:29px; margin-left: 90px; ">SEARCH</button>  </b> </pre>
          <div class="dropdown">
            <table>
                <tr>
                  <td>
                    <div class="dropdown"style=" margin-top:40px; margin-left: 90px;">
        ...
        <div class="dropdown"style=" margin-top:40px; margin-left: 90px;">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            <li><a class="dropdown-item" href="#">DD-MM-YY</a></li>
             </ul>
        </div>
    </td>
    <td>
    ...
    <button type="button" class="btn btn-dark"style=" width: 100px; margin-top:-65px; margin-left: 930px; ">RESET</button><br><br>
    <div style="border: 1px; background-color: lightblue;"></div>
        <div class="alert alert-success alert-dismissible fade show" role="alert" id="show" style="display: none;">
            <strong>Vendor</strong> has been blocked Seccusful
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
        <center><b>OREDER ID-76876756576</b></center><br><br>
        <pre class="h6"> <b>     SERVICE NAME :____                       ORDERD ID :_____                    DATE TIME______      </b></pre><br><br>
				...
				<div class="px-0 pt-4 pb-0 mt-3 mb-3"> 
					<form id="form"  > 
						<ul id="progressbar"> 
							...
							<li id="step2"><strong>PARTNER ASSONED </strong></li> 
							<li id="step3"><strong>INPROGESS  </strong></li> 
							<li id="step4"><strong>Completed</strong></li> 
...
<script src="progreass.js"></script> 
