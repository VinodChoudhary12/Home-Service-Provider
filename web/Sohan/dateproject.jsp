...
<body>
    ...
    <div class="row row-cols-lg-6 row-cols-md-4 row-cols-sm-3 mt-4 ms-3 p-4">
        <div id="div1" class="col  shadow-lg" style="background-color: white;color: rgb(255, 202, 8);"><p id="p1">Mon</p><h3 id="h">15</h3> </div>
        <div id="div1" class="col  shadow-lg"><p id="p1">Tue</p><h3 id="h">16</h3> </div>
        <div id="div1" class="col  shadow-lg"><p id="p1">Wed</p><h3 id="h">17</h3> </div>
        <div id="div1" class="col  shadow-lg"><p id="p1">Thu</p><h3 id="h">18</h3> </div>
        <div id="div1" class="col  shadow-lg "><p id="p1">Fri</p><h3 id="h">19</h3> </div>
        <div id="div1" class="col  shadow-lg"><p id="p1">Sat</p><h3 id="h">20</h3> </div>
...
<div class="row row-cols-lg-6 row-cols-md-4  ms-3 p-4">
    <div id="div2" class="col  shadow-lg" style="background-color: white;color: rgb(255, 202, 8);"><p id="p2">08:00 AM -</p><h3 id="h1">10:00 AM</h3> </div>
    <div id="div2" class="col  shadow-lg"><p id="p2">10:00 AM -</p><p id="h1">12:00 PM</p> </div>
    <div id="div2" class="col  shadow-lg"><p id="p2">12:00 PM -</p><h3 id="h1">02:00 PM</h3> </div>
    <div id="div2" class="col  shadow-lg"><p id="p2">02:00 PM -</p><h3 id="h1">04:00 PM</h3> </div>
    <div id="div2" class="col shadow-lg "><p id="p2">04:00 PM -</p><h3 id="h1">06:00 PM</h3> </div>
    <div id="div2" class="col shadow-lg"><p id="p2">06:00 PM -</p><h3 id="h1">08:00 PM</h3> </div>
