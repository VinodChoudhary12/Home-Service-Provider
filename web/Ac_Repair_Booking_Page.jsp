    ...
    <!-- <div class="container mt-5">
        <h2>
          ...
          <div class="row row-cols-lg-5 row-cols-md-2 row-cols-sm-2 row-cols-1 ms-5">
            ...
            <div class="col"><img id="img1" class="img-fluid ms-5 " src="https://d27vg8jo26ejl7.cloudfront.net/images/why_joboy/On-Demand-Scheduled.webp" alt=""><p class="p-1 mt-2">ON DEMAND /
              SCHEDULED</p></div>
